...
To ease API using, we provide an [R Package](https://tradestatistics.github.io/tradestatistics/). This package is aligned with [ROpenSci](https://ropensci.org/) directives and its documentation is available on a separate site.
