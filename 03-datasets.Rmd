...
By default the API takes `c = "all"` as default.
...
* `pci_*_method`: Product Complexity Index (PCI) which is detailed on [Open Trade Statistics Documentation](https://tradestatistics.github.io/documentation/). This index is built by using just four digits product codes.
...
* `eci_*_method`: Economic Complexity Index (ECI) which is detailed on [Open Trade Statistics Documentation](https://tradestatistics.github.io/documentation/). This index is built by using just four digits product codes.
...
As an example, let's read 1962 data and explore what the United Stated exported. This is the same information that you can obtain by using the API:
