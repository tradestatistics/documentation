...
* [Scraping data in The Atlas of Economic Complexity (OTS Atlas Data)](https://github.com/tradestatistics/ts-atlas-data)
...
Also, before running the scripts on Windows verify that you installed GNU Utilities beforehand. One easy option is to install [Chocolatey](https://chocolatey.org/) first and then install the GNU Utilities by running `choco install unxutils` Cmd or Power Shell as administrator.
